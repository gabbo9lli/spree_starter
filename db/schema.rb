...
ActiveRecord::Schema.define(version: 2022_02_12_222077) do
  ...
  create_table "spree_products_stores", force: :cascade do |t|
    t.bigint "product_id"
    t.bigint "store_id"
    t.datetime "created_at", default: "2024-04-08 19:42:34", null: false
    t.datetime "updated_at", default: "2024-04-08 19:42:34", null: false
